...
export default function HomePage() {
  ...
  const handleSearch = (e: React.FormEvent) => {
    ...
    navigate(
      query ? `/anuncios?busca=${encodeURIComponent(query)}` : "/anuncios"
    );
  };
  ...
  return (
    <>
      ...
      <section className="relative bg-[#0A3D62] overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 py-20 sm:py-28 text-center">
          ...
          <h1
            ...
            className="font-['Cormorant_Garamond'] text-5xl sm:text-6xl lg:text-7xl font-semibold text-white leading-[1.1] tracking-tight mb-6">
            Compre, venda e<br />
            <span className="text-[#7FD6E8] italic">conecte-se</span> com a
            comunidade
          </h1>
      ...
      <section
        ...
        className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-10">
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        <div className="relative rounded-3xl overflow-hidden border border-white/5 bg-[#0A3558]">
          ...
          {/* glow/sombra interna leve */}
          <div
            className="absolute inset-0 pointer-events-none"
            style={{
              boxShadow:
                "inset 0 8px 32px 0 rgba(56,182,217,0.18), inset 0 -8px 32px 0 rgba(12,90,134,0.18)"
            }}
          />
          <div className="relative px-8 py-20 sm:py-28 text-center">
            <h2 className="font-['Cormorant_Garamond'] text-4xl sm:text-5xl font-extrabold text-white mb-4 tracking-tight">
              Tem algo para anunciar?
            </h2>
            <p className="text-white/70 mb-8 text-base sm:text-lg tracking-wide">
              Publique grátis e alcance toda a comunidade do condomínio
            </p>
            <Link
              data-testid="publish-cta"
              to="/publicar"
              className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-md text-[#0C5A86] font-semibold px-8 py-3 rounded-xl hover:bg-[#f0f8ff]/80 transition-colors shadow-lg text-sm sm:text-base">
